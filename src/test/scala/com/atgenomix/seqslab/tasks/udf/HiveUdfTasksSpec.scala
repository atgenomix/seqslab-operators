package com.atgenomix.seqslab.tasks.udf

import com.atgenomix.seqslab.udf.hive.{ExceptSampleId, OpenAI, RetrievePositiveGenotype, RetrieveRsID}
...
class HiveUdfTasksSpec extends AnyFlatSpec {
  ...
  it should "query Azure com.atgenomix.seqslab.udf.hive.OpenAI with zero shot prompt" in {
  ...
  it should "query Azure com.atgenomix.seqslab.udf.hive.OpenAI with few shot prompt" in {
