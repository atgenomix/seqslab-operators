...
import com.atgenomix.seqslab.piper.plugin.atgenomix.HDFSCluster.startHDFS
import com.atgenomix.seqslab.piper.plugin.atgenomix.SparkHadoopSessionBuilder.{startRedis, stopRedis}
    ...
    this.synchronized {
      if (spark == null) {
        ...
        spark = SparkSession.builder()
          ...
          .config("spark.piper.plugins", "com.atgenomix.seqslab.piper.plugin.atgenomix.AtgenomixPiperPlugin")
