...
import com.atgenomix.seqslab.piper.plugin.atgenomix.operators.transformer.VepSelectTransformerFactory.VepSelectTransformer
...
object VepSelectTransformerFactory {
  ...
  class VepSelectTransformer(pluginCtx: PluginContext, operatorCtx: OperatorContext) extends Transformer {
    ...
    override def call(t1: DataFrame): DataFrame = {
      val className = "com.atgenomix.seqslab.piper.plugin.atgenomix.udf.hive.RetrievePattern"
