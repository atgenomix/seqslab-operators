...
import com.atgenomix.seqslab.piper.plugin.atgenomix.operators.partitioner.VcfPartitionerHg19Part3109UnpaddedFactory.VcfPartitionerHg19Part3109Unpadded
...
object VcfPartitionerHg19Part3109UnpaddedFactory {

  class VcfPartitionerHg19Part3109Unpadded(pluginCtx: PluginContext, operatorCtx: OperatorContext) extends Transformer {
    ...
    override def call(t1: Dataset[Row]): Dataset[Row] = {
      ...
      val parallelism = getClass.getResource("/bed/19/contiguous_unmasked_regions_3109_parts_unpadded")
      val ref = getClass.getResource("/reference/19/GRCH/ref.dict")
      val key_column = functions.call_udf("hg19part3109unpadded", t1.col("row"), lit(Int.MinValue))
...
class VcfPartitionerHg19Part3109UnpaddedFactory extends TransformerSupport {
  override def createTransformer(pluginContext: PluginContext, operatorContext: OperatorContext): Transformer = {
    new VcfPartitionerHg19Part3109Unpadded(pluginContext, operatorContext)
  }
}
