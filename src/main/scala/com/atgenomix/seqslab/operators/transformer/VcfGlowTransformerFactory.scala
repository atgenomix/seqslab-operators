...
import com.atgenomix.seqslab.piper.plugin.atgenomix.operators.transformer.VcfGlowTransformerFactory.VcfGlowTransformer
import com.atgenomix.seqslab.piper.plugin.atgenomix.operators.transformer.glow.VCFLineToInternalRowConverter
