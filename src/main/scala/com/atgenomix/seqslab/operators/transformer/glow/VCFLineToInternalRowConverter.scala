...
import io.projectglow.common.{GenotypeFields, HasStringency, VariantSchemas}
import io.projectglow.vcf.{FieldTypes, VariantContextToInternalRowConverter}
...
/**
  ...
  *                           parsing genotypes
  */
class VCFLineToInternalRowConverter(header: VCFHeader,
                                    schema: StructType,
                                    val stringency: ValidationStringency,
                                    overlapDetectorOpt: Option[OverlapDetector[SimpleInterval]])
  extends HasStringency with Serializable {
