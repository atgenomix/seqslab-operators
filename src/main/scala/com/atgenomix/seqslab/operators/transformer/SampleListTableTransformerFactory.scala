...
import com.atgenomix.seqslab.operators.transformer.SampleListTableTransformerFactory.SampleListTableTransformer
...
object SampleListTableTransformerFactory {
  ...
  class SampleListTableTransformer(pluginCtx: PluginContext, operatorCtx: OperatorContext) extends Transformer {
    ...
    override def call(t1: DataFrame): DataFrame = {
      val className = "com.atgenomix.seqslab.piper.plugin.atgenomix.udf.hive.com.atgenomix.seqslab.udf.hive.RetrievePositiveGenotype"
